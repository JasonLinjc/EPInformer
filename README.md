...
We evaluated EPInformer for enhancer–gene link prediction in K562 using the largest CRISPR benchmark dataset from the Engreitz Lab repository [link](https://github.com/EngreitzLab/CRISPR_comparison/blob/main/resources/crispr_data/EPCrisprBenchmark_ensemble_data_GRCh38.tsv.gz). 
